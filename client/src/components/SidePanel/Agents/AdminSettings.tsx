          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="btn btn-primary rounded font-bold text-white transition-all focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring-primary"
