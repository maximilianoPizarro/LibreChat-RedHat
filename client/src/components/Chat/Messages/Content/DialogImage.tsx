...
export default function DialogImage({ isOpen, onOpenChange, src = '', downloadImage, args }) {
  ...
  return (
    <OGDialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        <div
          className={`ease-custom-ease absolute left-0 top-0 z-10 flex items-center justify-between p-3 transition-all duration-500 sm:p-4 ${isPromptOpen ? 'right-0 sm:right-80' : 'right-0'}`}
        >
          <TooltipAnchor
        ...
        <div
          className={`ease-custom-ease flex h-full transition-all duration-500 ${isPromptOpen ? 'mr-0 sm:mr-80' : 'mr-0'}`}
        >
          <div
            ref={containerRef}
        ...
        {/* Side Panel */}
        <div
          className={`sm:shadow-l-lg ease-custom-ease fixed right-0 top-0 z-20 h-full w-full transform border-l border-border-light bg-surface-primary shadow-2xl backdrop-blur-sm transition-transform duration-500 sm:w-80 sm:rounded-l-2xl ${
